...
class TrendDetection:
    ...
    def relative_comparison(self):
        ...
        plt.savefig(f'/home/egovridc/PycharmProjects/spiderweb/spiderManager/spiderBend/TrendGraphs/{self.kw_list[0]}.png', orientation='landscape')

        return f'/home/egovridc/PycharmProjects/spiderweb/spiderManager/spiderBend/TrendGraphs/{self.kw_list[0]}.png'
